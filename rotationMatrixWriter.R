...
write.table(
  result$rtms_mag_list,"./datas/rtm_mag_top.csv",sep = ",",row.names = F, col.names =
    F
)
result = getMutipleRtms("./datas/3_10_data/lefthand/41.csv")
write.table(
  result$rtms_mag_list,"./datas/rtm_mag_lefthand.csv",sep = ",",row.names = F, col.names =
    F
)
result = getMutipleRtms("./datas/3_10_data/righthand/41.csv")
write.table(
  result$rtms_mag_list,"./datas/rtm_mag_righthand.csv",sep = ",",row.names = F, col.names =
    F
)
...
write.table(
  result$rtms_mag_list,"./datas/rtm_mag_leftpants.csv",sep = ",",row.names = F, col.names =
    F
)

result = getMutipleRtms("./datas/3_10_data/rightpants/41.csv")
write.table(
  result$rtms_mag_list,"./datas/rtm_mag_rightpants.csv",sep = ",",row.names = F, col.names =
    F
)
